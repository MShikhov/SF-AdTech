...
<body>
   ...
   <main style="text-align: center;">
    <a href="/redirect.php" style="float: left;">
        <img src="/img/back.svg" alt="back" class="back">
    </a>
    <a href="/executor/executor-sub.php">
    <button class="btn btn-primary " >Мои offer-ы</button>
    </a>
...
<p style="text-align: center;">Доступные offer-ы:</p>
    <?php include '/OpenServer/domains/SFAdTech/executor/executor-offers-sub.php'?>
   </main>
</body>
